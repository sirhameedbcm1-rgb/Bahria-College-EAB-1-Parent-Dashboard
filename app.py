...
# ================== UNIQUE PARENT ID (Best Method) ==================
df['Parent_ID'] = df["Father's Name"].astype(str).str.strip() + "___" + df["Mobile No"].astype(str).str.strip()
